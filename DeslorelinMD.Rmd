...
In other species, female sexual receptivity and genital morphology is mediated by estradiol. In ovariectomized rats, decreased estrogen levels resulted in vaginal atrophy, and the replacement of estrogen diminished this effect  [@bermanEffectEstrogenWithdrawal1998]. Research using Siberian hamsters demonstrated a link between estradiol levels and developing patency; increased estradiol resulted in larger uterine horns [@placeShortDayLengths2004]. There are some plausible explanations for why we did not see any changes in patency as a result of our long-acting GnRH agonist. We explored the possibility that our deslorelin implants unintentionally induced pseudopregnancy, which would disrupt our hypothesized pathway after implantation (Place and Molina, pers. communication). Acute GnRH administration can induce pseudopregnancy [@geyerReversibleEstrousCycle2016], though long-term agonists suppress cyclicity. Given that the gestation period of pouched rats is approximately 28-32 days [@ajayiGiantRatsMeat1974; Freeman, 2020 pers. communication], the possibility of a pseudopregnancy preventing vaginal closure for the entire 6-month period that we monitored is unlikely. We do not currently have measures of the reproductive organs of these pouched rats after deslorelin implantation, which would reveal if the uterine horns reduced in size over time with deslorelin [@placeShortDayLengths2004; @toydemirEffectsGnRHAnalogue2012]. However, previous imaging in this species indicated that nonpatent females have smaller uterine horns compared to patent females [@freemanOpenItAfrican2021].

It is possible that patency changes are not affected by or are less affected by changes at the level of GnRH. In female guinea pigs (_Cavia aperea_ f. _porcellus_), deslorelin administration was ineffective at reducing estradiol, and resulted in longer and more erratic periods of vaginal patency [@kohutovaEffectDeslorelinAcetate2015]. Deslorelin also appears ineffective in male guinea pigs, and does not significantly decrease circulating testosterone [@glocovaEffectGnRHAgonist2020a]. Other factors can also impact the HPG axis and reproductive maturation. For example, in naked mole rats, the onset of puberty is controlled by RFamide-related peptide-3 (RFRP-3), and its activity on central GnRH neurons inhibits reproduction [@peragineRFamiderelatedPeptide3RFRP32017]. Similarly, the kisspeptin neurons in the arcuate nucleus of the hypothalamus have a role in the onset of puberty [@uenoyamaCentralMechanismControlling2019]. Research into how these pathways might impact patency in pouched rats will shed light on the hormonal control of reproduction in this species.

 
_Scent marking_

We did not observe any significant difference in scent marking behavior between the treatment groups or among timepoints. We had predicted that during the early 'flare-up' of estradiol that is associated with deslorelin administration [@geyerReversibleEstrousCycle2016], females would advertise via scent marking due to increasing gonadal steroids. We also predicted that this would decrease to baseline or below baseline levels at week 6, similar to effects seen in domestic cat and dog marking behavior [@geyerReversibleEstrousCycle2016]. However, deslorelin did not impact scent marking behavior. 

In female rats and hamsters, scent marking behavior increases in the periovulatory part of the estrous cycle [@birkeScentmarkingOestrousCycle1978; @johnstonCausationTwoScentmarking1977], suggesting that females in these species might use specific marks to attract mates. However, in female prairie voles, reproductive state does not significantly affect scent marking, and females will mark at any point during the estrous cycle, with marks serving as a form of self-identification [@wolffScentMarkingFemale2002]. Therefore, pouched rat females might mark as a form of sel-identification. It is also possible that the stimuli type affected the likelihood for females to mark. Female hamsters (_Mesocricetus auratus_) demonstrated different scent marking behaviors when presented with male or female stimuli [@johnstonCausationTwoScentmarking1977]. As a result, exposure to a mixture of male urine might have yielded similar results due to the stimulus itself. If females use scent marking as a broad identity signal, then they should also scent mark to female stimuli independent of estrous cycle. However, this will need to be directly tested.

_Male Choice_

Males spent more time interacting with vehicle-treated females than with deslorelin-treated females, matching predictions. Males should search out fertile, receptive females for mating, and long-term treatment with GnRH typically impairs fertility and cycling. Indeed, males spent more time in proximity to these presumably fertile, vehicle-treated, females. To explore the behavior of males and females during these interactions, we examined the role of treatment on the proportion of time spent sniffing and engaging in aggressive behaviors (i.e., lunging, biting, and swatting). As predicted, males spent more time engaging in aggressive behaviors with females that were treated with deslorelin and were presumably non-fertile, whereas females treated with deslorelin also engaged in aggressive behaviors towards males. Potentially, the similar results from both sexes might be partially attributable to responses to aggression from the other party. Males and females treated with deslorelin also spent a larger proportion of interaction time sniffing one another. These nose-to-nose (most commonly observed) and nose-to-body behaviors often preceeded aggression when females were treated with deslorelin, which may account for the increased proportion of sniffing during interactions between males and deslorelin-treated females. 

Females that received vehicle implants spent approximately 25% of their time interacting with males sniffing the male. However, they rarely responded with aggression towards the male, and male aggression towards vehicle-implanted females was extremely rare. Thus, most of the time males and females spend interacting when females were implanted with vehicle were neutral - both were in the 'interaction' zone, but were not actively sniffing or fighting each other. These other neutral behaviors included grooming, climbing, rearing, walking, and standing still.

Male pouched rats can detect female patency through odor alone, and prefer to associate with odors from patent females [@freemanAnogenitalDistancePredicts2019]. In addition to being able to detect patency, these data show that males can additionally detect changes in female behavior or odor resulting from altered GnRH, and spend more time investigating control females who are presumably fertile. The ability to detect mate quality including fertility has been studied in other rodents [@goslingScentmarkingMaleMammals2001; @birkeScentmarkingOestrousCycle1978; @johnstonCausationTwoScentmarking1977; @coombesFemaleChemicalSignalling2018; @hurstScentWarsChemobiology2004; @thonhauserScentMarkingIncreases2013]. However, since female pouched rats can be patent but non-cycling, males might benefit from detecting both patency and fertility, since both are necessary for successful reproduction.

_Conclusion_
The long-term GnRH agonist impacts behavior, but not patency in female pouched rats. Female scent marking behavior was not affected by deslorelin treatment, however, interactions with a male were shorter and more aggressive. Deslorelin-treated females who are presumably acyclic are less receptive towards males. Furthermore, males spent more time investigating patent females that were not treated with deslorelin. Additional research is necessary to determine what physiological mechanism induces non-patency in the pouched rat. 
